...
from src.ports.task_instance_runner import TaskInstanceRunner
...
class SynchronousPipelineDriver:
    ...
    def __init__(self, orchestrator: WorkflowOrchestrator, task_instance_runner: TaskInstanceRunner, blob_store: BlobStore) -> None:
    ...
    def _run_step(self, *, tenant_id: uuid.UUID, workflow: Workflow, step_name: str) -> frozenset[str]:
        ...
        try:
            result = self._task_instance_runner.run_step(step_name, document_id=workflow.id, inputs=inputs)
